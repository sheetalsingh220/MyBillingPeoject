<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Due.aspx.cs" Inherits="BILLING.Due" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None" Height="255px" Width="660px">
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:sheetalDBConnectionString %>" SelectCommand="SELECT * FROM [Bill]"></asp:SqlDataSource>
